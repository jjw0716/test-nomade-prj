...
---
## Prompt Instruction
현재의 디자인을 5개의 새로운 디자인으로 새로 제작해줘. 각각 design_concepts 폴더에 index_1html, index_2html … 형태로 새로 파일을 만들어주고 파일 별로 완전 새로운 디자인을 생성해줘. 각 디자인은 subagent 가 담당할 수 있도록 병렬적으로 작업해줘.